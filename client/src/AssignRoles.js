...
function AssignRoles() {
  ...
  return (
    <div className="px-[3rem] py-[3rem]">
      <span>
        <b className="font-bold "> Current User Address :</b> {currentaccount}
      </span>
      ...
      >
        ...
        <input
          ...
          required
        />
        <button className="btn btn-success btn-sm" onSubmit={handlerSubmitRMS}>
          Register
        </button>
      </form>
      ...
      >
        ...
        <input
          ...
          required
        />
        <button className="btn btn-success btn-sm" onSubmit={handlerSubmitMAN}>
          Register
        </button>
      </form>
      <table className="table table-sm">
      ...
      >
        ...
        <input
          ...
          required
        />
        <button className="btn btn-success btn-sm" onSubmit={handlerSubmitDIS}>
          Register
        </button>
      </form>
      <table className="table table-sm">
      ...
      >
        ...
        <input
          ...
          required
        />
        <button className="btn btn-success btn-sm" onSubmit={handlerSubmitRET}>
          Register
        </button>
      </form>
      <table className="table table-sm">
